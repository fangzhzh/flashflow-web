...
export default {
  ...
  'tasks.energyPortal.title': 'How do you feel right now?',
  'tasks.energyPortal.subtitle': 'Select your current brain energy battery level to match the perfect task.',
  'tasks.energyPortal.full.title': 'Full Battery',
  'tasks.energyPortal.full.subtitle': 'High Cog + High Emot',
  'tasks.energyPortal.full.desc': 'Ready for planning, collaborative syncs, team alignment, or client demos.',
  'tasks.energyPortal.focus.title': 'Solo Focus',
  'tasks.energyPortal.focus.subtitle': 'High Cog + Low Emot',
  'tasks.energyPortal.focus.desc': 'Perfect for coding, algorithmic practice, reading, or deep system analysis.',
  'tasks.energyPortal.social.title': 'Social / Relax',
  'tasks.energyPortal.social.subtitle': 'Low Cog + High Emot',
  'tasks.energyPortal.social.desc': 'Good for light connection, chatting, patient listening, or family routines.',
  'tasks.energyPortal.recharge.title': 'Recharge / Rest',
  'tasks.energyPortal.recharge.subtitle': 'Low Cog + Low Emot',
  'tasks.energyPortal.recharge.desc': 'Best for review cards, organizing folder directories, stretching, or rest.',

  'tasks.energyWorkspace.full.title': 'Full Battery Workspace',
  'tasks.energyWorkspace.focus.title': 'Solo Focus Workspace',
  'tasks.energyWorkspace.social.title': 'Social / Relax Workspace',
  'tasks.energyWorkspace.recharge.title': 'Recharge / Rest Workspace',
  'tasks.energyWorkspace.matchingCount': 'Matching {count} task{plural} for your current energy.',
  'tasks.energyWorkspace.changeState': 'Change State',
  'tasks.energyWorkspace.allCaughtUp': 'All caught up!',
  'tasks.energyWorkspace.noTasksDesc': 'No pending tasks match this energy category. Recharge or select another state.',
  'tasks.energyWorkspace.aiOptimal': 'AI Optimal Task',
  'tasks.energyWorkspace.noAiTask': 'No recommended tasks.',
  'tasks.energyWorkspace.randomPick': 'Random Pick',
  'tasks.energyWorkspace.spinWheel': 'Spin Wheel',
  'tasks.energyWorkspace.reroll': 'Re-roll',
  'tasks.energyWorkspace.startTask': 'Start Task',
  'tasks.energyWorkspace.listAllTitle': 'List All Tasks in this Category ({count})',
  'tasks.energyWorkspace.randomPickDesc': 'Feeling indecisive? Let the wheel spin to select one task at random.',
